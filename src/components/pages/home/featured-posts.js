							...
							( post, index ) => (
								...
								>
									...
									<div className="featured-post-section__content">
										...
										{ post.excerpt ? (
											<p className="featured-post-section__content-paragraph">
												{ post.excerpt }
											</p>
										) : (
											''
