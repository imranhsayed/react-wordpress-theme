	...
	return heroSection ? (
		<div className="hero-section wrapper">
			<div className="hero-left">
				...
				{ heroSection.heroBtnTxt ? (
					<Link to="/blog">
						<button>{ heroSection.heroBtnTxt }</button>
					</Link>
				) : (
					<Link to="/blog">
						<button>{ config.heroSection.heroBtnTxt }</button>
					</Link>
				) }
			</div>
			<div className="hero-right">
				{ heroSection.heroImgURL ? (
					<img src={ heroSection.heroImgURL } alt="hero" />
				) : (
